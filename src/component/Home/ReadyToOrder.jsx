                ...
                >
                    {readyToOrder.map((item, index) => (
                        ...
                        >
                            ...
                            />
                            <h3 className="text-sm font-roboto text-[#7b7b7c] mb-2 font-medium leading-tight line-clamp-2">
                                {item.title}
                            </h3>
                            <p className="text-sm text-black font-semibold mt-4">
                                {item.price} <span className="text-gray-500 font-normal text-sm">/ Piece</span>
                            </p>
