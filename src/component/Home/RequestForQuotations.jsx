...
export default function RequestForQuotations() {
    ...
    return (
        <motion.div
            ...
            whileInView="visible"
            viewport={{ once: true }}
            className="w-full max-w-7xl mx-auto mt-10 px-4 sm:px-6 lg:px-8 font-roboto"
        >
            <div
                ...
                <div className="relative flex flex-col lg:flex-row gap-6 p-6 sm:p-10">
                    ...
                    <div className="text-white flex flex-col justify-center space-y-4 w-full lg:w-1/2">
                        ...
                        <motion.div
                            variants={fadeInUp}
                            custom={2}
                            className="text-xs sm:text-xs text-lightgray"
                        >
                            <p>impressio... and has received 1 quotation(s)</p>
                            <p>from India is looking for Ingots A7 and has received 2 quotations</p>
                        </motion.div>
